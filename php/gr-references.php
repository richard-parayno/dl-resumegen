...
$user_info = "INSERT INTO ResumeGeneratorRefs (create_date, name, position, contact_details, extra_info) VALUES ('$mysql_date_now' ,'$name', '$position','$contactDetails', '$extraInfo')"; 
